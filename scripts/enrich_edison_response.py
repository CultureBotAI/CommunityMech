...
For each ``research/communities/*-edison-*-meta.yaml`` carrying a real
...
Usage::
    ...
    # Limit to a specific community / pattern
...
import research_community_edison as rce  # noqa: E402  -- reuse load_api_key

DEFAULT_RESEARCH_DIR = REPO_ROOT / "research" / "communities"
