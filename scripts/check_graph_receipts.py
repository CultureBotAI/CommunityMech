...
from communitymech.graph_embedding_receipts import corpus_receipt, load_receipt  # noqa: E402

CORPUS_RELATIVE = "kb/communities"
RECEIPTS = [
    ("docs/community_umap.metadata.json", ("pacmap", "umap")),
    ("docs/community_graph.metadata.json", ("sfdp",)),
]
POINT_ID = "id"
