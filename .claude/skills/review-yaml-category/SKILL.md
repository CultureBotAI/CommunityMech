...
# Review one CommunityMech YAML record category

- Repository: `CultureBotAI/CommunityMech`
- Records: `kb/communities/*.yaml`, `data/isolates/*.yaml`
